...
class CrispyChickenScreen extends StatefulWidget {
  const CrispyChickenScreen({super.key});

  @override
  _CrispyChickenScreenState createState() => _CrispyChickenScreenState();
}

class _CrispyChickenScreenState extends State<CrispyChickenScreen> {
  final Map<String, int> items = {
    'Chicken Nuggets': 0,
    'Spicy Chicken Wings': 0,
    'Grilled Chicken': 0,
    'Chicken Popcorn': 0,
  };
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Crispy Chicken'),
        leading: IconButton(
