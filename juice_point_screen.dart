...
class JuicePointPage extends StatefulWidget {
  const JuicePointPage({super.key});

  @override
  _JuicePointPageState createState() => _JuicePointPageState();
}

class _JuicePointPageState extends State<JuicePointPage> {
  // Items available in the Juice Point
