...
class NesCafePage extends StatefulWidget {
  const NesCafePage({super.key});

  @override
  _NesCafePageState createState() => _NesCafePageState();
}

class _NesCafePageState extends State<NesCafePage> {
  // Items available in the NesCafe menu
